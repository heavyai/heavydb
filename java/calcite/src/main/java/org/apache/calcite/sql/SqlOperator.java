...
public abstract class SqlOperator {
  ...
  //   This only exists to allow us to identify if a UDF will add         // HEAVY.AI new
  //   default values to the operand list during a later phase            // HEAVY.AI new
  //   and therefore require special handling ... to be recreated         // HEAVY.AI new
  //                                                                      // HEAVY.AI new
  public boolean requiresCreate(List<SqlNode> operands) {                 // HEAVY.AI new
    return false;                                                         // HEAVY.AI new
  }                                                                       // HEAVY.AI new
