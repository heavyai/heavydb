 ...
 *
 * This file is a modified derivative of Apache Calcite's org.apache.calcite.prepare.PlannerImpl.
 *
...
public class PlannerImpl implements Planner, ViewExpander {
  ...
  // HeavyAI modification: factory method to allow HeavyDBPlanner to substitute
  // HeavyDBSqlToRelConverter. Both instantiation sites in this class call this
  // method rather than new SqlToRelConverter(...) directly.
  ...
  @Override public RelRoot rel(SqlNode sql) {
    ...
    final SqlToRelConverter sqlToRelConverter =
        createSqlToRelConverter(this, validator,
  ...
  // HEAVY.AI: changed from `private` to `protected` so HeavyDBPlanner can
  // override to install HeavyDBRexBuilder for the SQL-text path.
