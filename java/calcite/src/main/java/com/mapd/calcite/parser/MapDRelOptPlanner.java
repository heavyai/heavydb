...
/**
 * MapDRelOptPlanner is a mock implementation of the {@link RelOptPlanner} interface.
 */
public class MapDRelOptPlanner extends AbstractRelOptPlanner {
  //~ Instance fields --------------------------------------------------------
  ...
  //~ Methods ----------------------------------------------------------------
  /**
   * Creates MapDRelOptPlanner.
   */
  public MapDRelOptPlanner() {
  ...
  //~ Inner Classes ----------------------------------------------------------
  /**
   * MapD call to a planner rule.
   */
  private class MapDRuleCall extends RelOptRuleCall {

    /**
     * Creates a MapDRuleCall.
     *
