 ...
 */
DEVICE static const BaseCellRotation faceIjkBaseCells[NUM_ICOSA_FACES][3][3][3] = {
    {// face 0
     {
         // i 0
         {{16, 0}, {18, 0}, {24, 0}},  // j 0
...
DEVICE const BaseCellData baseCellData[NUM_BASE_CELLS] = {
    ...
    {{1, 0, 0, 1}, 0, {0, 0}},     // base cell 0
    {{1, 1, 0, 2}, 0, {0, 0}},     // base cell 1
    {{0, 0, 0, 1}, 0, {0, 0}},     // base cell 2
    {{1, 0, 0, 2}, 0, {0, 0}},     // base cell 3
    {{2, 0, 0, 0}, 1, {-1, -1}},   // base cell 4
    {{1, 1, 0, 1}, 0, {0, 0}},     // base cell 5
    {{0, 0, 1, 1}, 0, {0, 0}},     // base cell 6
    {{0, 0, 0, 2}, 0, {0, 0}},     // base cell 7
    {{1, 0, 0, 0}, 0, {0, 0}},     // base cell 8
    {{0, 1, 0, 2}, 0, {0, 0}},     // base cell 9
    {{0, 1, 0, 1}, 0, {0, 0}},     // base cell 10
    {{0, 1, 1, 1}, 0, {0, 0}},     // base cell 11
    {{1, 0, 0, 3}, 0, {0, 0}},     // base cell 12
    {{1, 1, 0, 3}, 0, {0, 0}},     // base cell 13
    {{2, 0, 0, 11}, 1, {2, 6}},    // base cell 14
    {{1, 0, 0, 4}, 0, {0, 0}},     // base cell 15
    {{0, 0, 0, 0}, 0, {0, 0}},     // base cell 16
    {{0, 1, 0, 6}, 0, {0, 0}},     // base cell 17
    {{0, 0, 1, 0}, 0, {0, 0}},     // base cell 18
    {{0, 1, 1, 2}, 0, {0, 0}},     // base cell 19
    {{0, 0, 1, 7}, 0, {0, 0}},     // base cell 20
    {{0, 0, 1, 2}, 0, {0, 0}},     // base cell 21
    {{1, 1, 0, 0}, 0, {0, 0}},     // base cell 22
    {{0, 0, 1, 6}, 0, {0, 0}},     // base cell 23
    {{2, 0, 0, 10}, 1, {1, 5}},    // base cell 24
    {{0, 0, 0, 6}, 0, {0, 0}},     // base cell 25
    {{0, 0, 0, 3}, 0, {0, 0}},     // base cell 26
    {{1, 0, 0, 11}, 0, {0, 0}},    // base cell 27
    {{1, 1, 0, 4}, 0, {0, 0}},     // base cell 28
    {{0, 1, 0, 3}, 0, {0, 0}},     // base cell 29
    {{0, 1, 1, 0}, 0, {0, 0}},     // base cell 30
    {{0, 0, 0, 4}, 0, {0, 0}},     // base cell 31
    {{0, 1, 0, 5}, 0, {0, 0}},     // base cell 32
    {{0, 1, 0, 0}, 0, {0, 0}},     // base cell 33
    {{0, 1, 0, 7}, 0, {0, 0}},     // base cell 34
    {{1, 1, 0, 11}, 0, {0, 0}},    // base cell 35
    {{0, 0, 0, 7}, 0, {0, 0}},     // base cell 36
    {{1, 0, 0, 10}, 0, {0, 0}},    // base cell 37
    {{2, 0, 0, 12}, 1, {3, 7}},    // base cell 38
    {{1, 0, 1, 6}, 0, {0, 0}},     // base cell 39
    {{1, 0, 1, 7}, 0, {0, 0}},     // base cell 40
    {{0, 0, 1, 4}, 0, {0, 0}},     // base cell 41
    {{0, 0, 1, 3}, 0, {0, 0}},     // base cell 42
    {{0, 1, 1, 3}, 0, {0, 0}},     // base cell 43
    {{0, 1, 0, 4}, 0, {0, 0}},     // base cell 44
    {{1, 0, 0, 6}, 0, {0, 0}},     // base cell 45
    {{0, 0, 0, 11}, 0, {0, 0}},    // base cell 46
    {{0, 0, 1, 8}, 0, {0, 0}},     // base cell 47
    {{0, 0, 1, 5}, 0, {0, 0}},     // base cell 48
    {{2, 0, 0, 14}, 1, {0, 9}},    // base cell 49
    {{0, 0, 0, 5}, 0, {0, 0}},     // base cell 50
    {{1, 0, 0, 12}, 0, {0, 0}},    // base cell 51
    {{1, 1, 0, 10}, 0, {0, 0}},    // base cell 52
    {{0, 1, 1, 4}, 0, {0, 0}},     // base cell 53
    {{1, 1, 0, 12}, 0, {0, 0}},    // base cell 54
    {{1, 0, 0, 7}, 0, {0, 0}},     // base cell 55
    {{0, 1, 0, 11}, 0, {0, 0}},    // base cell 56
    {{0, 0, 0, 10}, 0, {0, 0}},    // base cell 57
    {{2, 0, 0, 13}, 1, {4, 8}},    // base cell 58
    {{0, 0, 1, 10}, 0, {0, 0}},    // base cell 59
    {{0, 0, 1, 11}, 0, {0, 0}},    // base cell 60
    {{0, 1, 0, 9}, 0, {0, 0}},     // base cell 61
    {{0, 1, 0, 8}, 0, {0, 0}},     // base cell 62
    {{2, 0, 0, 6}, 1, {11, 15}},   // base cell 63
    {{0, 0, 0, 8}, 0, {0, 0}},     // base cell 64
    {{0, 0, 1, 9}, 0, {0, 0}},     // base cell 65
    {{1, 0, 0, 14}, 0, {0, 0}},    // base cell 66
    {{1, 0, 1, 5}, 0, {0, 0}},     // base cell 67
    {{0, 1, 1, 16}, 0, {0, 0}},    // base cell 68
    {{1, 0, 1, 8}, 0, {0, 0}},     // base cell 69
    {{1, 0, 0, 5}, 0, {0, 0}},     // base cell 70
    {{0, 0, 0, 12}, 0, {0, 0}},    // base cell 71
    {{2, 0, 0, 7}, 1, {12, 16}},   // base cell 72
    {{0, 1, 0, 12}, 0, {0, 0}},    // base cell 73
    {{0, 1, 0, 10}, 0, {0, 0}},    // base cell 74
    {{0, 0, 0, 9}, 0, {0, 0}},     // base cell 75
    {{1, 0, 0, 13}, 0, {0, 0}},    // base cell 76
    {{0, 0, 1, 16}, 0, {0, 0}},    // base cell 77
    {{0, 1, 1, 15}, 0, {0, 0}},    // base cell 78
    {{0, 1, 0, 15}, 0, {0, 0}},    // base cell 79
    {{0, 1, 0, 16}, 0, {0, 0}},    // base cell 80
    {{1, 1, 0, 14}, 0, {0, 0}},    // base cell 81
    {{1, 1, 0, 13}, 0, {0, 0}},    // base cell 82
    {{2, 0, 0, 5}, 1, {10, 19}},   // base cell 83
    {{1, 0, 0, 8}, 0, {0, 0}},     // base cell 84
    {{0, 0, 0, 14}, 0, {0, 0}},    // base cell 85
    {{1, 0, 1, 9}, 0, {0, 0}},     // base cell 86
    {{0, 0, 1, 14}, 0, {0, 0}},    // base cell 87
    {{0, 0, 1, 17}, 0, {0, 0}},    // base cell 88
    {{0, 0, 1, 12}, 0, {0, 0}},    // base cell 89
    {{0, 0, 0, 16}, 0, {0, 0}},    // base cell 90
    {{0, 1, 1, 17}, 0, {0, 0}},    // base cell 91
    {{0, 0, 1, 15}, 0, {0, 0}},    // base cell 92
    {{1, 0, 1, 16}, 0, {0, 0}},    // base cell 93
    {{1, 0, 0, 9}, 0, {0, 0}},     // base cell 94
    {{0, 0, 0, 15}, 0, {0, 0}},    // base cell 95
    {{0, 0, 0, 13}, 0, {0, 0}},    // base cell 96
    {{2, 0, 0, 8}, 1, {13, 17}},   // base cell 97
    {{0, 1, 0, 13}, 0, {0, 0}},    // base cell 98
    {{1, 0, 1, 17}, 0, {0, 0}},    // base cell 99
    {{0, 1, 0, 19}, 0, {0, 0}},    // base cell 100
    {{0, 1, 0, 14}, 0, {0, 0}},    // base cell 101
    {{0, 1, 1, 19}, 0, {0, 0}},    // base cell 102
    {{0, 1, 0, 17}, 0, {0, 0}},    // base cell 103
    {{0, 0, 1, 13}, 0, {0, 0}},    // base cell 104
    {{0, 0, 0, 17}, 0, {0, 0}},    // base cell 105
    {{1, 0, 0, 16}, 0, {0, 0}},    // base cell 106
    {{2, 0, 0, 9}, 1, {14, 18}},   // base cell 107
    {{1, 0, 1, 15}, 0, {0, 0}},    // base cell 108
    {{1, 0, 0, 15}, 0, {0, 0}},    // base cell 109
    {{0, 1, 1, 18}, 0, {0, 0}},    // base cell 110
    {{0, 0, 1, 18}, 0, {0, 0}},    // base cell 111
    {{0, 0, 1, 19}, 0, {0, 0}},    // base cell 112
    {{1, 0, 0, 17}, 0, {0, 0}},    // base cell 113
    {{0, 0, 0, 19}, 0, {0, 0}},    // base cell 114
    {{0, 1, 0, 18}, 0, {0, 0}},    // base cell 115
    {{1, 0, 1, 18}, 0, {0, 0}},    // base cell 116
    {{2, 0, 0, 19}, 1, {-1, -1}},  // base cell 117
    {{1, 0, 0, 19}, 0, {0, 0}},    // base cell 118
    {{0, 0, 0, 18}, 0, {0, 0}},    // base cell 119
    {{1, 0, 1, 19}, 0, {0, 0}},    // base cell 120
    {{1, 0, 0, 18}, 0, {0, 0}}     // base cell 121
};
...
EXTENSION_INLINE int _faceIjkToBaseCell(const FaceIJK(h)) {
  return faceIjkBaseCells[h[FACE_INDEX]][h[I_INDEX]][h[J_INDEX]][h[K_INDEX]].baseCell;
}
...
EXTENSION_INLINE int _faceIjkToBaseCellCCWrot60(const FaceIJK(h)) {
  return faceIjkBaseCells[h[FACE_INDEX]][h[I_INDEX]][h[J_INDEX]][h[K_INDEX]].ccwRot60;
}
