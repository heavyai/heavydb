...
void DdlWalker::visit(CreateStmt *v) {
    ...
    // otherwise, create the table partitioner for the new table
    tpm_->createPartitionerForTable(tblName_, Partitioner_Namespace::LINEAR); // @todo Check for error from createPartitionerForTable
 }
