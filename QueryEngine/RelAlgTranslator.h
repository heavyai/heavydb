...
class RelAlgTranslator {
 ...
 private:
  ...
  std::vector<std::shared_ptr<Analyzer::Expr>> translateGeoFunctionArg(const RexScalar*,
                                                                       SQLTypeInfo&,
                                                                       int32_t&,
                                                                       bool) const;

  std::vector<std::shared_ptr<Analyzer::Expr>> translateGeoColumn(const RexInput*, SQLTypeInfo&, bool) const;
