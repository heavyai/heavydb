...
extern "C" RUNTIME_EXPORT void agg_max_skip_val(int64_t* agg, const int64_t val, const int64_t skip_val);

extern "C" RUNTIME_EXPORT void agg_min_skip_val(int64_t* agg, const int64_t val, const int64_t skip_val);
...
extern "C" RUNTIME_EXPORT int64_t* get_matching_group_value_perfect_hash(int64_t* groups_buffer,
                                                          const uint32_t h,
                                                          const int64_t* key,
                                                          const uint32_t key_qw_count,
                                                          const uint32_t row_size_quad);
...
extern "C" RUNTIME_EXPORT int32_t* get_bucketized_hash_slot(int32_t* buff,
                                             const int64_t key,
                                             const int64_t min_key,
...
extern "C" RUNTIME_EXPORT int32_t* get_hash_slot_sharded(int32_t* buff,
                                          const int64_t key,
                                          const int64_t min_key,
...
extern "C" RUNTIME_EXPORT int32_t* get_bucketized_hash_slot_sharded(int32_t* buff,
                                                     const int64_t key,
                                                     const int64_t min_key,
                                                     const uint32_t entry_count_per_shard,
                                                     const uint32_t num_shards,
...
extern "C" RUNTIME_EXPORT int32_t* get_hash_slot_sharded_opt(int32_t* buff,
                                              const int64_t key,
                                              const int64_t min_key,
                                              const uint32_t entry_count_per_shard,
...
extern "C" RUNTIME_EXPORT int fill_hashtable_for_semi_join(size_t idx,
                                            int32_t* entry_ptr,
                                            const int32_t invalid_slot_val);
...
extern "C" RUNTIME_EXPORT int64_t fixed_width_int_decode_noinline(const int8_t* byte_stream,
                                                   const int32_t byte_width,
                                                   const int64_t pos);

extern "C" RUNTIME_EXPORT int64_t fixed_width_unsigned_decode_noinline(const int8_t* byte_stream,
                                                        const int32_t byte_width,
                                                        const int64_t pos);

extern "C" RUNTIME_EXPORT float fixed_width_float_decode_noinline(const int8_t* byte_stream,
                                                   const int64_t pos);

extern "C" RUNTIME_EXPORT double fixed_width_double_decode_noinline(const int8_t* byte_stream,
                                                     const int64_t pos);

extern "C" RUNTIME_EXPORT int64_t fixed_width_small_date_decode_noinline(const int8_t* byte_stream,
                                                          const int32_t byte_width,
