// The majority of this file was pulled from the pytorch
// torchvision repo (pytorch:torchvision/csrc/ops/autocast/nms_kernel.cpp)
// which is under a BSD 3-Clause license. The full license terms can
// be viewed here: https://github.com/pytorch/vision/blob/main/LICENSE
...
at::Tensor nms_kernel_impl(const at::Tensor& dets,
  ...
  auto order_t =
      std::get<1>(scores.sort(/*stable=*/true, /*dim=*/0, /* descending=*/true));
