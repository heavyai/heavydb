...
DEF_ARITH_NULLABLE(int8_t, int8_t, mod, % )
DEF_ARITH_NULLABLE(int16_t, int16_t, mod, % )
DEF_ARITH_NULLABLE(int32_t, int32_t, mod, % )
DEF_ARITH_NULLABLE(int64_t, int64_t, mod, % )
DEF_ARITH_NULLABLE_LHS(int8_t, int8_t, mod, % )
DEF_ARITH_NULLABLE_LHS(int16_t, int16_t, mod, % )
DEF_ARITH_NULLABLE_LHS(int32_t, int32_t, mod, % )
DEF_ARITH_NULLABLE_LHS(int64_t, int64_t, mod, % )
DEF_ARITH_NULLABLE_RHS(int8_t, int8_t, mod, % )
DEF_ARITH_NULLABLE_RHS(int16_t, int16_t, mod, % )
DEF_ARITH_NULLABLE_RHS(int32_t, int32_t, mod, % )
