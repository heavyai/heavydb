...
service MapD {
  ...
  list<string> get_users(1: TSessionId session) throws (1: TMapDException e 2: ThriftException te)
  list<TDBInfo> get_databases(1: TSessionId session) throws (1: TMapDException e 2: ThriftException te)
  ...
  string get_version() throws (1: TMapDException e 2: ThriftException te)
  string get_memory_gpu(1: TSessionId session) throws (1: TMapDException e 2: ThriftException te)
  TMemorySummary get_memory_summary(1: TSessionId session) throws (1: TMapDException e 2: ThriftException te)
  ...
  TPixelTableRowResult get_result_row_for_pixel(1: TSessionId session, 2: i64 widget_id, 3: TPixel pixel, 4: map<string, list<string>> table_col_names, 5: bool column_format, 6: i32 pixelRadius, 7: string nonce) throws (1: TMapDException e 2: ThriftException te)
  ...
  TStepResult execute_first_step(1: TSessionId session, 2: string query 3: bool column_format, 4: string nonce) throws (1: TMapDException e 2: ThriftException te)
  TQueryId start_query(1: TSessionId session, 2: string query_ra 3: bool column_format, 4: string nonce) throws (1: TMapDException e 2: ThriftException te)
