...
service MapD {
  ...
  list<string> get_users(1: TSessionId session) throws (1: ThriftException te)
  list<TDBInfo> get_databases(1: TSessionId session) throws (1: ThriftException te)
  ...
  string get_memory_gpu(1: TSessionId session) throws (1: ThriftException te)
  TMemorySummary get_memory_summary(1: TSessionId session) throws (1: ThriftException te)
