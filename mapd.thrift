...
service MapD {
  ...
  TRenderResult testRenderSimplePolys(1: TSessionId session, 2: string query, 3: string render_type, 4: string nonce) throws (1: TMapDException e 2: ThriftException te)
