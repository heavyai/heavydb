...
namespace Partitioner_Namespace {
    ...
    private:
         ...
         * being created
         *
         * @param columnDescriptors list of columnDescriptor pointers (generated by
        ...
        void translateColumnDescriptorsToColumnInfoVec (const std::list <const ColumnDescriptor *> &columnDescriptors, std::vector<ColumnInfo> &columnInfoVec);
