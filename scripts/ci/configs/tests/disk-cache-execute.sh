...
# Test variant: ExecuteTest --use-disk-cache under TSAN. Source of truth for
# test-disk-cache-execute in weekly.yml. Reuses the disk-cache-tsan build.
...
export RESULTS_FILE="test-results-disk-cache-execute.xml"
