...
class TCopyParams(object):
    ...
    def __init__(self, delimiter=None, null_str=None, has_header=0, quoted=None, quote=None, escape=None, line_delim=None, array_delim=None, array_begin=None, array_end=None, threads=None, source_type=0, s3_access_key=None, s3_secret_key=None, s3_region=None, geo_coords_encoding=6, geo_coords_comp_param=32, geo_coords_type=18, geo_coords_srid=4326, sanitize_column_names=True, geo_layer_name=None, s3_endpoint=None, geo_assign_render_groups=False, geo_explode_collections=False, source_srid=0, s3_session_token=None, raster_point_type=1, raster_import_bands=None, raster_scanlines_per_thread=None, raster_point_transform=1, raster_point_compute_angle=False, raster_import_dimensions=None, odbc_dsn=None, odbc_connection_string=None, odbc_sql_select=None, odbc_sql_order_by=None, odbc_username=None, odbc_password=None, odbc_credential_string=None, add_metadata_columns=None, trim_spaces=True, geo_validate_geometry=False,):
        ...
        self.geo_validate_geometry = geo_validate_geometry
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.geo_validate_geometry = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.trim_spaces is not None:
            ...
            oprot.writeFieldEnd()
        if self.geo_validate_geometry is not None:
            oprot.writeFieldBegin('geo_validate_geometry', TType.BOOL, 42)
            oprot.writeBool(self.geo_validate_geometry)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TServerStatus(object):
    ...
    def __init__(self, read_only=None, version=None, rendering_enabled=None, start_time=None, edition=None, host_name=None, poly_rendering_enabled=None, role=None, renderer_status_json=None, host_id=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.host_id = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.host_id is not None:
            oprot.writeFieldBegin('host_id', TType.STRING, 10)
...
class TTableDetails(object):
    ...
    def __init__(self, row_desc=None, fragment_size=None, page_size=None, max_rows=None, view_sql=None, shard_count=None, key_metainfo=None, is_temporary=None, partition_detail=None, table_type=None, refresh_info=None, sharded_column_name=None,):
        self.row_desc = row_desc
        ...
        self.sharded_column_name = sharded_column_name
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.sharded_column_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.refresh_info is not None:
            ...
            oprot.writeFieldEnd()
        if self.sharded_column_name is not None:
            oprot.writeFieldBegin('sharded_column_name', TType.STRING, 12)
            oprot.writeString(self.sharded_column_name.encode('utf-8') if sys.version_info[0] == 2 else self.sharded_column_name)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TCopyParams.thrift_spec = (
    ...
    (41, TType.BOOL, 'trim_spaces', None, True, ),  # 41
    (42, TType.BOOL, 'geo_validate_geometry', None, False, ),  # 42
)
...
TServerStatus.thrift_spec = (
    ...
    (10, TType.STRING, 'host_id', 'UTF8', None, ),  # 10
)
...
TTableDetails.thrift_spec = (
    ...
    (12, TType.STRING, 'sharded_column_name', 'UTF8', None, ),  # 12
)
