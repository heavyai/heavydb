...
class TStringDictKey(object):
    ...
    def __init__(self, db_id=None, dict_id=None,):
        self.db_id = db_id
...
class TTypeInfo(object):
    ...
    def __init__(self, type=None, encoding=None, nullable=None, is_array=None, precision=None, scale=None, comp_param=None, size=-1, dict_key=None,):
        self.type = type
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.dict_key = TStringDictKey()
                    self.dict_key.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.dict_key is not None:
            oprot.writeFieldBegin('dict_key', TType.STRUCT, 9)
            self.dict_key.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(TStringDictKey)
TStringDictKey.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'db_id', None, None, ),  # 1
    (2, TType.I32, 'dict_id', None, None, ),  # 2
)
...
TTypeInfo.thrift_spec = (
    ...
    (9, TType.STRUCT, 'dict_key', [TStringDictKey, None], None, ),  # 9
)
