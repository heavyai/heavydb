...
| Ubuntu | DEB | CPU | https://releases.heavy.ai/os/apt/stable/cpu | https://docs.heavy.ai/installation-and-configuration/installation/installing-on-ubuntu/centos-yum-gpu-ee |
| Ubuntu | DEB | GPU | https://releases.heavy.ai/os/apt/stable/cuda | https://docs.heavy.ai/installation-and-configuration/installation/installing-on-ubuntu/centos-yum-gpu-ee |
