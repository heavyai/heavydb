...
class MissingOp : public AggOp,
                  public AggOpResultsInterface<MissingOp>,
                  public ThrustOpInterface {
 public:
  MissingOp(const XformShPtr& parent_xform,
  ...
  ~MissingOp() override = default;
  static OpType operatorType() { return OpType::kCountMissing; }
...
template <>
struct OpSelector<OpType::kCountMissing> {
  using type = MissingOp;
};
