...
- removal of hcl support due to MPL license
...
* setting defaults
* reading from JSON, TOML, YAML, and Java properties config files
...
1. Find, load, and unmarshal a configuration file in JSON, TOML, YAML, or Java properties formats.
...
Viper supports JSON, TOML, YAML, and Java Properties files. Viper can search multiple paths, but
...
Viper will read a config string (as JSON, TOML, YAML) retrieved from a path
