  ...
  sqlAndCompareResult("SELECT * FROM inttable;",
    {
      ...
      // due to floating-point precision/rounding/conversion differences
      // ARM does NOT reject these two rows
...
TEST_F(ImportTestInt, ImportGoodInt) {
  ...
  // clang-format off
  sqlAndCompareResult("SELECT * FROM inttable ORDER BY rowid;",
    {
      {9223372036854775807L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L},
      {-9223372036854775807L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L},
