...
def main():
    ...
    For more details see: https://issues.apache.org/jira/browse/THRIFT-2642
    ...
    thrift_specs = [td.parent for td in red_ast.find_all(
        'name', 'thrift_spec') if td.parent.type == 'assignment']
