...
public class ForeignServerTest extends DDLTest {
  ...
  public void DropServerDdlCommand() throws Exception {
    ...
    final PlanResult result = processDdlCommand("DROP SERVER test_server;");
    final JsonObject actualJsonObject =
            gson.fromJson(result.planResult, JsonObject.class);
  ...
  public void DropServerDdlCommandWithIfExists() throws Exception {
    ...
    final PlanResult result = processDdlCommand("DROP SERVER IF EXISTS test_server;");
    final JsonObject actualJsonObject =
            gson.fromJson(result.planResult, JsonObject.class);
  ...
  public void ShowForeignServers() throws Exception {
    ...
    final PlanResult result = processDdlCommand("SHOW SERVERS;");
    final JsonObject actualJsonObject =
            gson.fromJson(result.planResult, JsonObject.class);
    assertEquals(expectedJsonObject, actualJsonObject);
  }
