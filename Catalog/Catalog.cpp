...
void Catalog::buildMaps() {
  ...
  string columnQuery(
      ...
      "size, chunks, is_systemcol, is_virtualcol, virtual_expr, is_deletedcol, is_hotcol, bufs_fetched, unique_chunks_fetched, data_fetched from "
    ...
    try {
      ...
      for (auto cd : columns) {
        ...
        sqliteConnector_.query_with_text_params(
            ...
            "virtual_expr, is_deletedcol, is_hotcol, bufs_fetched, unique_chunks_fetched, data_fetched) "
            "VALUES (?, ?, ?, ?, ?, "
            "?, "
            "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            std::vector<std::string>{std::to_string(td.tableId),
