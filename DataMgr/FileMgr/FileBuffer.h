...
namespace File_Namespace {
    ...
    class FileBuffer : public AbstractBuffer {
        ...
        public:
            ...
            FileBuffer(FileMgr *fm, const size_t pageSize, const ChunkKey &chunkKey, const SQLTypes sqlType, const EncodingType encodingType, const int encodingBits, const size_t initialSize = 0);
            ...
            virtual void read(int8_t * const dst, const size_t numBytes = 0, const BufferType dstBufferType = CPU_BUFFER, const size_t offset = 0);
